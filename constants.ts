...
export const INITIAL_CONTENT: PageContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      details: { 
        en: 'We are developing an educational and participatory model of sustainable urban agriculture that promotes regenerative agricultural practices, local food security, and intergenerational connection (children, youth, and seniors) around ecological cultivation in urban contexts.\n“Since February 2025, we have been developing it in the community garden of the Engelwood Neighborhood Center, in alliance with the city of Orlando.”\n\nRecent Activities:\n\nPapayas, Seedlings, and Mental Health in the Engelwood Garden\nOn August 26, we held the \'Garden and Coffee\' learning day at the community garden of the Engelwood Neighborhood Center in Orlando. The activity involved seniors from the center and the Magnolias residence, who learned about food production using agricultural and hydroponic techniques, harvested papayas, and helped prepare lettuce seedlings. They also shared breakfast and received a mental health talk from the Renacer Foundation team. The activity is part of the actions planned in the project, \'Faith Community Forest, an ecological corridor in Central Florida,\' carried out by Christ the King Episcopal Church in Orlando, FL, in partnership with Renacer Foundation, the Hispanic Environmental Observatory, Calao Corp, and Corpus Care, with funding from the #NuestrosBosques program of the Hispanic Access Foundation.', 
        es: 'Desarrollamos un modelo educativo y participativo de agricultura urbana sostenible que promueve prácticas agrícolas regenerativas, seguridad alimentaria local y conexión intergeneracional (niños, jóvenes y adultos mayores) en torno al cultivo ecológico en contextos urbanos.\n“Desde febrero de 2025 lo desarrollamos en el Jardín comunitario del Engelwood Neighborhood Center, en alianza con la ciudad de Orlando.”\n\nActividades Recientes:\n\nPapayas, semilleros y salud mental en el huerto de Engelwood\nEl 26 de agosto, desarrollamos la jornada de aprendizaje “Huerto y café”, en el huerto comunitario del Engelwood Neighborhood Center en Orlando, la actividad contó con la participación de adultos mayores del mencionado centro y de la residencia Magnolias, quienes aprendieron sobre la producción de alimentos mediante técnicas agrícolas e hidropónicas, cosecharon papayas, y ayudaron a desarrollar semilleros de lechugas. Además, compartieron un desayuno y recibieron una charla de salud mental del equipo de Renacer Foundation. La actividad, forma parte de las acciones previstas en el proyecto, "Bosque Comunitario de Fe, un corredor ecológico en la Florida Central", ejecutado por Christ the King Episcopal Church in Orlando, FL, en alianza con Renacer Foundation, el Observatorio Ambiental Hispano, Calao Corp y Corpus Care, mediante el financiamiento del programa #NuestrosBosques de la Hispanic Access Foundation.' 
      },
    ...
    },
    {
      ...
      details: { 
        en: 'We promote Hispanic environmental leadership in the U.S. through a platform of scientific information, training, and community action in Spanish. The purpose is to reduce Hispanic underrepresentation in environmental decision-making spaces, and increase their participation in solving socio-environmental problems and local projects. Through alliances with various organizations to strengthen a network of leaders committed to sustainability and environmental justice.\n\nRecent Activities:\n\nCitizen Campaign for Extreme Heat\nOn July 31, 2025, we launched a social media campaign to alert the public about the health impacts of extreme heat. In recent days in Central Florida, we have experienced oppressive heat, with high temperatures exceeding averages from recent years. We are sharing this information with you so you can be prepared and take timely measures for symptoms related to heat and your health.\n\nRecognition from Casa Venezuela Orlando\nOn July 5, 2025, we received recognition for our work. Thank you to Casa Venezuela Orlando for this important recognition of our work on behalf of the Hispanic community here in the United States, in the context of Venezuela\'s Independence Day. It is an honor! #TheGoodGuysAreMore', 
        es: 'Impulsamos el liderazgo ambiental hispano en EE.UU. mediante una plataforma de información científica, formación y acción comunitaria en español. Con el propósito de reducir la subrepresentación hispana en los espacios de decisión ambiental, y aumentar su participación en la solución de problemáticas socioambientales y proyectos locales. A través de alianzas con diversas organizaciones para fortalecer una red de líderes comprometidos con la sostenibilidad y la justicia ambiental.\n\nActividades Recientes:\n\nCampaña ciudadana por calor extremo\nEl 31 de julio 2025, realizamos una campaña en redes sociales para alertar a la ciudadanía sobre las incidencias en la salud del calor extremo. Los últimos días en la Florida Central, hemos experimentado calores agobiantes, con altas temperaturas que superan los promedios en los últimos años. Compartimos con ustedes, está información para que estén prevenidos y puedan tomar medidas oportunas ante sintonías que relacionadas al calor y su salud.\n\nReconocimiento de Casa Venezuela Orlando\nEl 5 de julio 2025, recibimos un reconocimiento a nuestra labor. Gracias a Casa Venezuela Orlando por este importante reconocimiento a nuestra labor en pro de la comunidad hispana acá en Estados Unidos. en el marco del Día de la Independencia de Venezuela. Es un honor! #LosBuenosSomosMas' 
      },
