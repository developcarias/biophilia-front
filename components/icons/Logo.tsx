...
const Logo: React.FC = () => (
    ...
    >
        ...
        <text x="0" y="26" className="logo-text" fontSize="28" fill="#66bb6a">Bio</text>
        ...
        <rect x="72" y="34" width="72" height="17" fill="#66bb6a" rx="2"></rect>
        <text x="76" y="48" className="logo-text" fontSize="13" fill="#004d40">Institute</text>
    </svg>
);
