      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="mt-12 pt-8 border-t">
            <h3 className="text-center text-xl font-bold text-brand-gray mb-4">{t('sharePost')}</h3>
        ...
        {recentPosts.length > 0 && (
            <div className="max-w-7xl mx-auto mt-20 pt-12 border-t">
                <h2 className="text-3xl font-bold text-brand-green-dark text-center mb-8">{t('recentPosts')}</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {recentPosts.map((recentPost) => (
                        <NavLink to={`/blog/${recentPost.slug}`} key={recentPost.id} className="group bg-brand-green-light rounded-lg shadow-lg overflow-hidden flex flex-col transition-transform transform hover:-translate-y-2 hover:shadow-2xl">
